...
// Update the avatar expression based on user current streak
...
const GoalPage = () => {
  ...
  useEffect(() => {
    // Send a message generated by AI about the user progress
    const callOpenAi = async (goal) => {
      try {
        ...
        setAiMessage(response.data.content);
      } catch (err) {
        setAiMessage(null);
      } finally {
        setIsTyping(false);
    ...
    <div className="mt-6 md:mx-auto md:w-full md:max-w-lg">
      <div className="md:mx-auto md:w-full md:max-w-lg relative">
        ...
        <div className="flex items-center space-x-2 justify-end">
          {isTyping ? (
            <div className="p-3 rounded-xl max-w-sm bg-gray-100 ml-auto flex space-x-1">
            ...
            aiMessage && (
              <div className="p-3 rounded-xl max-w-sm bg-gray-100 ml-auto">
                {aiMessage}
              </div>
            )
          )}
          ...
          <div className="relative w-12 h-12 p-[2px] rounded-full bg-gradient-to-r from-[#BE50C0] to-[#F5C419]">
            <Image
              ...
              className="w-full h-full rounded-full bg-white p-1 object-cover object-center scale-x-[-1]"
              width={100}
              height={100}
            />
          </div>
